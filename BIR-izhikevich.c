...
#include <math.h>
#include <time.h>
#include "BIR_izhikevich_param_V1.h" //Reading header file of V1 parameters
#include "BIR_izhikevich_param_VHO.h" //Reading header file of VHO parameters
#include "BIR_izhikevich_resultfile_V1.h" //Reading header file of V1 resultfiles
#include "BIR_izhikevich_resultfile_VHO.h" //Reading header file of VHO resultfiles
...
int main(){
	...
	for (train_count = 0; train_count < Train_Task_Total; train_count++) {
        for(train_bisection = -2; train_bisection <= 2; train_bisection++){ //Move bisection offset
			...
			for(train_vernier = -2; train_vernier <= 2; train_vernier++){ //Move vernier offset
                ...
                for(t = train_time_start; t <= train_time_end; t = t + dt){
						...
						for(j = 0; j < V1_Y_RANGE; j++){
							...
							if(train_V_V1[i][j] >= th_V1){
                                ...
                                if(train_count == 0){
                                    //V1 center
									if(i == 9 && j == 9){
										fprintf(train_bir_v1_center, "%lf %lf\n", t, train_V_V1[i][j]);
										fprintf(train_bir_X_v1_center, "%lf %lf\n", t, train_X_V1[i][j]);
									}
                                    //V1 left
                                    if(i == 2 && j == 9){
										fprintf(train_bir_v1_left, "%lf %lf\n", t, train_V_V1[i][j]);
										fprintf(train_bir_X_v1_left, "%lf %lf\n", t, train_X_V1[i][j]);
									}
                                    //V1 right
									if(i == 12 && j == 9){
										fprintf(train_bir_v1_right, "%lf %lf\n", t, train_V_V1[i][j]);
										fprintf(train_bir_X_v1_right, "%lf %lf\n", t, train_X_V1[i][j]);
									}
                                    //V1 top
									if(i == 7 && j == 4){
										fprintf(train_bir_v1_top, "%lf %lf\n", t, train_V_V1[i][j]);
										fprintf(train_bir_X_v1_top, "%lf %lf\n", t, train_X_V1[i][j]);
									}
									//V1 bottom
									if(i == 7 && j == 15){
										fprintf(train_bir_v1_bottom, "%lf %lf\n", t, train_V_V1[i][j]);
										fprintf(train_bir_X_v1_bottom, "%lf %lf\n", t, train_X_V1[i][j]);
									}
								}
							...
							if(train_V1_PV_V[i][j] >= th_V1){
                        		...
                        		if(train_count == 0){
									if(i == 9 && j == 9){
									fprintf(train_bir_pv_v1_center, "%lf %lf\n", t, train_V1_PV_V[i][j]);
									fprintf(train_bir_X_pv_v1_center, "%lf %lf\n", t, train_V1_PV_X[i][j]);
									}
								}
							...
							if(train_V1_SOM_V[i][j] >= th_V1){
                        		...
                        		if(train_count == 0){
									if(i == 9 && j == 9){
									fprintf(train_bir_som_v1_center, "%lf %lf\n", t, train_V1_SOM_V[i][j]);
									fprintf(train_bir_X_som_v1_center, "%lf %lf\n", t, train_V1_SOM_X[i][j]);
									}
									if(i == 12 && j == 9){
									fprintf(train_bir_som_v1_right, "%lf %lf\n", t, train_V1_SOM_V[i][j]);
									}
								}
                   ...
                   /*End to V1 firing judgment*/
					...
					for(i = 0; i < VHO_X_RANGE; i++){
						for(j = 0; j < VHO_Y_RANGE; j++){
							...
							if(train_V_VHO[i][j] >= th_VHO){
                                ...
                                if(train_count == 0){
									if(i == 9 && j == 1){
										fprintf(train_bir_vho_center, "%lf %lf\n", t, train_V_VHO[i][j]);
										fprintf(train_bir_X_vho_center, "%lf %lf\n", t, train_X_VHO[i][j]);
									}
                                    if(i == 2 && j == 1){
										fprintf(train_bir_vho_left, "%lf %lf\n", t, train_V_VHO[i][j]);
										fprintf(train_bir_X_vho_left, "%lf %lf\n", t, train_X_VHO[i][j]);
									}
									if(i == 12 && j == 1){
										fprintf(train_bir_vho_right, "%lf %lf\n", t, train_V_VHO[i][j]);
										fprintf(train_bir_X_vho_right, "%lf %lf\n", t, train_X_VHO[i][j]);
									}
									if(i == 7 && j == 0){
										fprintf(train_bir_vho_top, "%lf %lf\n", t, train_V_VHO[i][j]);
										fprintf(train_bir_X_vho_top, "%lf %lf\n", t, train_X_VHO[i][j]);
									}
									if(i == 7 && j == 2){
										fprintf(train_bir_vho_bottom, "%lf %lf\n", t, train_V_VHO[i][j]);
										fprintf(train_bir_X_vho_bottom, "%lf %lf\n", t, train_X_VHO[i][j]);
									}
								}
							...
							if(train_VHO_PV_V[i][j] >= th_VHO){
                        		...
                        		if(train_count == 0){
									if(i == 9 && j == 1){
									fprintf(train_bir_pv_vho_center, "%lf %lf\n", t, train_VHO_PV_V[i][j]);
									fprintf(train_bir_X_pv_vho_center, "%lf %lf\n", t, train_VHO_PV_X[i][j]);
									}
								}
							...
							if(train_VHO_SOM_V[i][j] >= th_VHO){
                        		...
                        		if(train_count == 0){
									if(i == 9 && j == 1){
									fprintf(train_bir_som_vho_center, "%lf %lf\n", t, train_VHO_SOM_V[i][j]);
									fprintf(train_bir_X_som_vho_center, "%lf %lf\n", t, train_VHO_SOM_X[i][j]);
									}
								}
					...
					if((t_lfp % T_LFP) == 0){
						if(t > 200.0 && t <= 400.0){
							fprintf(bir_lfp_v1_center_synapse, "%lf\n", LFP_synapse_V1[0] / 4.0);
							fprintf(bir_lfp_v1_left_synapse, "%lf\n", LFP_synapse_V1[1] / 4.0);
							fprintf(bir_lfp_v1_right_synapse, "%lf\n", LFP_synapse_V1[2] / 4.0);
							fprintf(bir_lfp_v1_top_synapse, "%lf\n", LFP_synapse_V1[3] / 4.0);
							fprintf(bir_lfp_v1_bottom_synapse, "%lf\n", LFP_synapse_V1[4] / 4.0);

							fprintf(bir_lfp_vho_center_synapse, "%lf\n", LFP_synapse_VHO[0]);
							fprintf(bir_lfp_vho_left_synapse, "%lf\n", LFP_synapse_VHO[1]);
							fprintf(bir_lfp_vho_right_synapse, "%lf\n", LFP_synapse_VHO[2]);
							fprintf(bir_lfp_vho_top_synapse, "%lf\n", LFP_synapse_VHO[3]);
							fprintf(bir_lfp_vho_bottom_synapse, "%lf\n", LFP_synapse_VHO[4]);
						}
						if(t > 600.0 && t <= 800.0){
							fprintf(bir_lfp_v1_center_synapse, "%lf\n", LFP_synapse_V1[0] / 4.0);
							fprintf(bir_lfp_v1_left_synapse, "%lf\n", LFP_synapse_V1[1] / 4.0);
					...
					for(i = 0; i < V1_X_RANGE; i++){
						for(j = 0; j < V1_Y_RANGE; j++){
                            ...
                            if(train_count == 0){
								if(i == 9 && j == 9){
									fprintf(train_bir_Input_v1_center, "%lf %lf\n", t, train_I_V1[i][j]);
                                    fprintf(train_bir_S_ex_v1_center, "%lf %lf\n", t, train_S_ex_V1[i][j]);
									fprintf(train_bir_S_inh_from_pv_v1_center, "%lf %lf\n", t, train_S_inh_from_pv_V1[i][j]);
									fprintf(train_bir_S_inh_from_som_v1_center, "%lf %lf\n", t, train_S_inh_from_som_V1[i][j]);
									fprintf(train_bir_S_v1_center, "%lf %lf\n", t, (train_S_ex_V1[i][j] + train_S_inh_V1[i][j]));
									fprintf(train_bir_Top_v1_center, "%lf %lf\n", t, train_TOP_V1[i][j]);

									fprintf(train_bir_Input_pv_v1_center, "%lf %lf\n", t, train_V1_PV_I[i][j]);
                                    fprintf(train_bir_S_ex_pv_v1_center, "%lf %lf\n", t, train_V1_PV_S_ex[i][j]);

									fprintf(train_bir_Input_som_v1_center, "%lf %lf\n", t, train_V1_SOM_I[i][j]);
                                    fprintf(train_bir_S_ex_som_v1_center, "%lf %lf\n", t, train_V1_SOM_S_ex[i][j]);
									fprintf(train_bir_S_som_v1_center, "%lf %lf\n", t, train_V1_SOM_S_ex[i][j]);
								}
								if(i == 12 && j == 9){								
									fprintf(train_bir_Input_v1_right, "%lf %lf\n", t, train_I_V1[i][j]);
                                    fprintf(train_bir_S_ex_v1_right, "%lf %lf\n", t, train_S_ex_V1[i][j]);
									fprintf(train_bir_S_inh_v1_right, "%lf %lf\n", t, train_S_inh_V1[i][j]);
									fprintf(train_bir_S_v1_right, "%lf %lf\n", t, (train_S_ex_V1[i][j] + train_S_inh_V1[i][j]));

									fprintf(train_bir_Input_pv_v1_right, "%lf %lf\n", t, train_V1_PV_I[i][j]);
                                    fprintf(train_bir_S_ex_pv_v1_right, "%lf %lf\n", t, train_V1_PV_S_ex[i][j]);

									fprintf(train_bir_Input_som_v1_right, "%lf %lf\n", t, train_V1_SOM_I[i][j]);
                                    fprintf(train_bir_S_ex_som_v1_right, "%lf %lf\n", t, train_V1_SOM_S_ex[i][j]);
								}
								if(i == 2 && j == 9){
									fprintf(train_bir_Input_v1_left, "%lf %lf\n", t, train_I_V1[i][j]);
                                    fprintf(train_bir_S_ex_v1_left, "%lf %lf\n", t, train_S_ex_V1[i][j]);
									fprintf(train_bir_S_inh_v1_left, "%lf %lf\n", t, train_S_inh_V1[i][j]);
									fprintf(train_bir_S_v1_left, "%lf %lf\n", t, (train_S_ex_V1[i][j] + train_S_inh_V1[i][j]));

									fprintf(train_bir_Input_pv_v1_left, "%lf %lf\n", t, train_V1_PV_I[i][j]);
                                    fprintf(train_bir_S_ex_pv_v1_left, "%lf %lf\n", t, train_V1_PV_S_ex[i][j]);

									fprintf(train_bir_Input_som_v1_left, "%lf %lf\n", t, train_V1_SOM_I[i][j]);
                                    fprintf(train_bir_S_ex_som_v1_left, "%lf %lf\n", t, train_V1_SOM_S_ex[i][j]);
								}
								if(i == 7 && j == 4){
                                    fprintf(train_bir_Input_v1_top, "%lf %lf\n", t, train_I_V1[i][j]);
                                    fprintf(train_bir_S_ex_v1_top, "%lf %lf\n", t, train_S_ex_V1[i][j]);
									fprintf(train_bir_S_inh_v1_top, "%lf %lf\n", t, train_S_inh_V1[i][j]);
									fprintf(train_bir_S_v1_top, "%lf %lf\n", t, (train_S_ex_V1[i][j] + train_S_inh_V1[i][j]));

									fprintf(train_bir_Input_pv_v1_top, "%lf %lf\n", t, train_V1_PV_I[i][j]);
                                    fprintf(train_bir_S_ex_pv_v1_top, "%lf %lf\n", t, train_V1_PV_S_ex[i][j]);

									fprintf(train_bir_Input_som_v1_top, "%lf %lf\n", t, train_V1_SOM_I[i][j]);
                                    fprintf(train_bir_S_ex_som_v1_top, "%lf %lf\n", t, train_V1_SOM_S_ex[i][j]);
                                }
								if(i == 7 && j == 15){
                                    fprintf(train_bir_Input_v1_bottom, "%lf %lf\n", t, train_I_V1[i][j]);
                                    fprintf(train_bir_S_ex_v1_bottom, "%lf %lf\n", t, train_S_ex_V1[i][j]);
									fprintf(train_bir_S_inh_v1_bottom, "%lf %lf\n", t, train_S_inh_V1[i][j]);
									fprintf(train_bir_S_v1_bottom, "%lf %lf\n", t, (train_S_ex_V1[i][j] + train_S_inh_V1[i][j]));

									fprintf(train_bir_Input_pv_v1_bottom, "%lf %lf\n", t, train_V1_PV_I[i][j]);
                                    fprintf(train_bir_S_ex_pv_v1_bottom, "%lf %lf\n", t, train_V1_PV_S_ex[i][j]);

									fprintf(train_bir_Input_som_v1_bottom, "%lf %lf\n", t, train_V1_SOM_I[i][j]);
                                    fprintf(train_bir_S_ex_som_v1_bottom, "%lf %lf\n", t, train_V1_SOM_S_ex[i][j]);
                                }
							}
					...
					for(i = 0; i < VHO_X_RANGE; i++){
						for(j = 0; j < VHO_Y_RANGE; j++){
                            ...
                            if(train_count == 0){
								if(i == 9 && j == 1){
									fprintf(train_bir_Input_vho_center, "%lf %lf\n", t, train_I_VHO[i][j]);
                                    fprintf(train_bir_S_ex_vho_center, "%lf %lf\n", t, train_S_ex_VHO[i][j]);
									fprintf(train_bir_S_inh_from_pv_vho_center, "%lf %lf\n", t, train_S_inh_from_pv_VHO[i][j]);
									fprintf(train_bir_S_inh_from_som_vho_center, "%lf %lf\n", t, train_S_inh_from_som_VHO[i][j]);
									fprintf(train_bir_Bot_vho_center, "%lf %lf\n", t, train_BOT_VHO[i][j]);
									fprintf(train_bir_Top_vho_center, "%lf %lf\n", t, train_TOP_VHO[i][j]);
									fprintf(train_bir_S_vho_center, "%lf %lf\n", t, (train_S_ex_VHO[i][j] + train_S_inh_VHO[i][j]));

									fprintf(train_bir_Input_pv_vho_center, "%lf %lf\n", t, train_VHO_PV_I[i][j]);
                                    fprintf(train_bir_S_ex_pv_vho_center, "%lf %lf\n", t, train_VHO_PV_S_ex[i][j]);
									fprintf(train_bir_S_pv_vho_center, "%lf %lf\n", t, train_VHO_PV_S_ex[i][j]);

									fprintf(train_bir_Input_som_vho_center, "%lf %lf\n", t, train_VHO_SOM_I[i][j]);
                                    fprintf(train_bir_S_ex_som_vho_center, "%lf %lf\n", t, train_VHO_SOM_S_ex[i][j]);
									fprintf(train_bir_S_som_vho_center, "%lf %lf\n", t, train_VHO_SOM_S_ex[i][j]);
								}
								if(i == 12 && j == 1){								
									fprintf(train_bir_Input_vho_right, "%lf %lf\n", t, train_I_VHO[i][j]);
                                    fprintf(train_bir_S_ex_vho_right, "%lf %lf\n", t, train_S_ex_VHO[i][j]);
									fprintf(train_bir_S_inh_vho_right, "%lf %lf\n", t, train_S_inh_VHO[i][j]);
									fprintf(train_bir_Bot_vho_right, "%lf %lf\n", t, train_BOT_VHO[i][j]);
									fprintf(train_bir_S_vho_right, "%lf %lf\n", t, (train_S_ex_VHO[i][j] + train_S_inh_VHO[i][j]));

									fprintf(train_bir_Input_pv_vho_right, "%lf %lf\n", t, train_VHO_PV_I[i][j]);
                                    fprintf(train_bir_S_ex_pv_vho_right, "%lf %lf\n", t, train_VHO_PV_S_ex[i][j]);

									fprintf(train_bir_Input_som_vho_right, "%lf %lf\n", t, train_VHO_SOM_I[i][j]);
                                    fprintf(train_bir_S_ex_som_vho_right, "%lf %lf\n", t, train_VHO_SOM_S_ex[i][j]);
								}
								if(i == 2 && j == 1){
									fprintf(train_bir_Input_vho_left, "%lf %lf\n", t, train_I_VHO[i][j]);
                                    fprintf(train_bir_S_ex_vho_left, "%lf %lf\n", t, train_S_ex_VHO[i][j]);
									fprintf(train_bir_S_inh_vho_left, "%lf %lf\n", t, train_S_inh_VHO[i][j]);
									fprintf(train_bir_Bot_vho_left, "%lf %lf\n", t, train_BOT_VHO[i][j]);
									fprintf(train_bir_S_vho_left, "%lf %lf\n", t, (train_S_ex_VHO[i][j] + train_S_inh_VHO[i][j]));

									fprintf(train_bir_Input_pv_vho_left, "%lf %lf\n", t, train_VHO_PV_I[i][j]);
                                    fprintf(train_bir_S_ex_pv_vho_left, "%lf %lf\n", t, train_VHO_PV_S_ex[i][j]);

									fprintf(train_bir_Input_som_vho_left, "%lf %lf\n", t, train_VHO_SOM_I[i][j]);
                                    fprintf(train_bir_S_ex_som_vho_left, "%lf %lf\n", t, train_VHO_SOM_S_ex[i][j]);
								}
								if(i == 7 && j == 0){
                                    fprintf(train_bir_Input_vho_top, "%lf %lf\n", t, train_I_VHO[i][j]);
                                    fprintf(train_bir_S_ex_vho_top, "%lf %lf\n", t, train_S_ex_VHO[i][j]);
									fprintf(train_bir_S_inh_vho_top, "%lf %lf\n", t, train_S_inh_VHO[i][j]);
									fprintf(train_bir_Bot_vho_top, "%lf %lf\n", t, train_BOT_VHO[i][j]);
									fprintf(train_bir_S_vho_top, "%lf %lf\n", t, (train_S_ex_VHO[i][j] + train_S_inh_VHO[i][j]));

									fprintf(train_bir_Input_pv_vho_top, "%lf %lf\n", t, train_VHO_PV_I[i][j]);
                                    fprintf(train_bir_S_ex_pv_vho_top, "%lf %lf\n", t, train_VHO_PV_S_ex[i][j]);

									fprintf(train_bir_Input_som_vho_top, "%lf %lf\n", t, train_VHO_SOM_I[i][j]);
                                    fprintf(train_bir_S_ex_som_vho_top, "%lf %lf\n", t, train_VHO_SOM_S_ex[i][j]);
                                }
								if(i == 7 && j == 2){
                                    fprintf(train_bir_Input_vho_bottom, "%lf %lf\n", t, train_I_VHO[i][j]);
                                    fprintf(train_bir_S_ex_vho_bottom, "%lf %lf\n", t, train_S_ex_VHO[i][j]);
									fprintf(train_bir_S_inh_vho_bottom, "%lf %lf\n", t, train_S_inh_VHO[i][j]);
									fprintf(train_bir_Bot_vho_bottom, "%lf %lf\n", t, train_BOT_VHO[i][j]);
									fprintf(train_bir_S_vho_bottom, "%lf %lf\n", t, (train_S_ex_VHO[i][j] + train_S_inh_VHO[i][j]));

									fprintf(train_bir_Input_pv_vho_bottom, "%lf %lf\n", t, train_VHO_PV_I[i][j]);
                                    fprintf(train_bir_S_ex_pv_vho_bottom, "%lf %lf\n", t, train_VHO_PV_S_ex[i][j]);

									fprintf(train_bir_Input_som_vho_bottom, "%lf %lf\n", t, train_VHO_SOM_I[i][j]);
                                    fprintf(train_bir_S_ex_som_vho_bottom, "%lf %lf\n", t, train_VHO_SOM_S_ex[i][j]);
                                }
							}
			...
			if(train_count == 0){
				fprintf(bir_tuning_VHO_center, "center %d %lf\n", train_bisection, pattern_VHO_center);
				fprintf(bir_tuning_VHO_left, "left %d %lf\n", train_bisection, pattern_VHO_left);
				fprintf(bir_tuning_VHO_right, "right %d %lf\n", train_bisection, pattern_VHO_right);
				fprintf(bir_tuning_VHO_top, "left %d %lf\n", train_bisection, pattern_VHO_top);
				fprintf(bir_tuning_VHO_bottom, "right %d %lf\n", train_bisection, pattern_VHO_bottom);
				if(train_bisection == -2){
					fprintf(bir_tuning_VHO, "left %lf\ncenter %lf\nright %lf\n", pattern_VHO_left, pattern_VHO_center, pattern_VHO_right);
				}
			}
