...
const double w_inh_VHO_PV_PC_Relevant = 6.0;
...
const double w_inh_VHO_SOM_PC_Relevant = 25.0;
...
//SOM disinhibition
const double Input_T = 100.0; //one cycle of square wave
const double Topdown_SOM = 15.0; //weight of topdown